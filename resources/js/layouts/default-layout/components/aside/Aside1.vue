      ...
      >
        ...
        >
          ...
          <!--end::Menu item-->
            ...
            <div class="menu-item">
              <router-link
                to="/customer/devs/inventory"
                active-class="active"
                class="menu-link"
              >
                <span class="menu-title">Digital Inventory</span>
              </router-link>
            </div>
            <!--end::Menu item-->
