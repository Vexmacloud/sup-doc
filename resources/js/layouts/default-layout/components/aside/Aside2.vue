    ...
    >
      ...
      >
        ...
        <div >
          ...
          <div class="menu-item">
            <router-link
              to="/employee/devs/orderBatchPlan"
              active-class="active"
              class="menu-link"
            >
              <span class="menu-title">Order Batch Plan</span>
            </router-link>
          </div>
          <!--end::Menu item-->
          <!--begin::Menu item-->
         ...
         <div class="menu-item pt-5">
          ...
          <div class="menu-item">
            <router-link
              to="/employee/devs/purchaseorder"
              active-class="active"
              class="menu-link"
            >
          ...
          <div class="menu-item">
            <router-link
              to="/employee/devs/inwardqc"
              active-class="active"
              class="menu-link"
            >
              <span class="menu-title">Inward QC</span>
            </router-link>
          </div>
          <!--end::Menu item-->
          ...
          <!--end::Heading-->
           ...
           <div class="menu-item">
            <router-link
              to="/employee/devs/deal"
              active-class="active"
              class="menu-link"
            >
              <span class="menu-title">Deal</span>
            </router-link>
          </div>
          <!--end::Menu item-->
          <!--begin::Menu item-->
