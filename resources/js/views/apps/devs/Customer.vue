    ...
    const steps = ref([
      {
        ...
        details: [
          "Admins and designated employees can access the “Add Customer” form from the Customer Management section.",
      ...
      },
      {
        ...
        tip: "Remind customers to check their spam/junk folders if they don’t receive the welcome email promptly."
      },
